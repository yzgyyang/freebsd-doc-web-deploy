  ...
  The FreeBSD Project
   ...
   This document gives a brief introduction to FreeBSD 12.2-RELEASE. It
...
1. Introduction
   ...
   This distribution is a release of FreeBSD 12.2-RELEASE, the latest point
  ...
  1.2. Target Audience
   ...
   11.4-RELEASE) are frequently more appropriate. Releases undergo a period
  ...
  4.1. Release Documentation
   ...
   Portable Document Format (.PDF).
     ...
     * RELNOTES.TXT: The release notes, showing what's new and different in
       FreeBSD 12.2-RELEASE compared to the previous release (FreeBSD
       12.1-RELEASE).
